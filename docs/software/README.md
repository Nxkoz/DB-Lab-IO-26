...
-- Table `mydb`.`reles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`reles` (
  `Id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`role_grant`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`role_grant` (
  `RoleID` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`projects_members`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`projects_members` (
